...
public interface TableFileMapper {
    ...
    int updateByExampleSelective(@Param("record") TableFile record, @Param("example") TableFileExample example);

    int updateByExampleWithBLOBs(@Param("record") TableFile record, @Param("example") TableFileExample example);

    int updateByExample(@Param("record") TableFile record, @Param("example") TableFileExample example);
